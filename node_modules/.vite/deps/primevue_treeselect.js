import {
  script as script15
} from "./chunk-GRLUYDON.js";
import "./chunk-SK7PQ5H6.js";
import {
  script as script14
} from "./chunk-FKZLLG53.js";
import {
  script as script12
} from "./chunk-YMSOCWOO.js";
import {
  script as script13
} from "./chunk-HN5VWHWF.js";
import {
  script as script10
} from "./chunk-EQUECD22.js";
import {
  script as script11
} from "./chunk-YCHC63JM.js";
import {
  OverlayEventBus
} from "./chunk-ZI2FEKUJ.js";
import {
  script as script4
} from "./chunk-ORFB6MCV.js";
import {
  script as script6,
  script2 as script8
} from "./chunk-2UZ44WWJ.js";
import {
  script as script5
} from "./chunk-7EFAXWUT.js";
import {
  script as script7
} from "./chunk-6MBZXFTW.js";
import "./chunk-E3WWGNB2.js";
import {
  script as script9
} from "./chunk-36VTFOAR.js";
import {
  script as script3
} from "./chunk-R6J23W74.js";
import {
  script as script2
} from "./chunk-QJT3EC7A.js";
import {
  ConnectedOverlayScrollHandler,
  UniqueComponentId
} from "./chunk-UTPTGJYI.js";
...
import {
  Ripple
} from "./chunk-WGY6VM4C.js";
import "./chunk-7K3R2MUR.js";
import "./chunk-JKGRDULH.js";
import "./chunk-U272EPSW.js";
import {
  script
} from "./chunk-4QN6EIFK.js";
...
var script17 = {
  ...
  watch: {
    ...
    expandedKeys: function expandedKeys2(value) {
  ...
  methods: {
    ...
    updateTreeState: function updateTreeState() {
      var keys = _objectSpread$12({}, this.d_value);
    ...
    expandPath: function expandPath(path) {
      if (path.length > 0) {
        ...
        this.d_expandedKeys = _objectSpread$12({}, this.d_expandedKeys);
        this.$emit("update:expandedKeys", this.d_expandedKeys);
      }
    },
    ...
    label: function label3() {
      ...
      if (value.length) {
        if (isNotEmpty(this.maxSelectedLabels) && value.length > this.maxSelectedLabels) {
          label4 = this.getSelectedItemsLabel();
        } else {
          label4 = value.map(function(node2) {
            return node2.label;
          }).join(", ");
        }
      } else {
        label4 = this.placeholder;
      }
      return label4;
    },
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return [_ctx.display === "comma" ? (openBlock(), createElementBlock(Fragment, {
      ...
      key: 1
    }, [$options.chipSelectedItems ? (openBlock(), createElementBlock("span", _hoisted_22, toDisplayString($options.label), 1)) : (openBlock(), createElementBlock(Fragment, {
      key: 1
