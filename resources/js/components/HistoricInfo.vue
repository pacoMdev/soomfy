                          ...
                          <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4 w-100" :class="{ 'border-t border-surface-200 dark:border-surface-700': index !== 0 }">
                            ...
                            <div class="flex flex-row md:flex-col justify-between items-start gap-2">
                                <div>
                                    ...
                                    <div class="text-lg font-small mt-2">{{ item.seller.name }} {{ item.seller.surname1 }}</div>
                            ...
                            <div class="flex flex-col md:flex-row justify-content-end md:items-center flex-1 gap-6 w-100">
                              <span class="font-medium text-surface-500 dark:text-surface-400 text-sm">{{ new Date(item.created_at).toLocaleDateString("es-ES", {
  day: "2-digit",
  month: "2-digit",
  year: "numeric",
}) }}</span>
                                ...
                                <div class="flex flex-col md:items-end gap-8">
                                    <span v-if="item.finalPrice < initialPrice" class="text-xl font-semibold">
