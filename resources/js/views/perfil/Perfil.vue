      ...
      <div class="profile-header">
        <div v-if="user.email" class="profile-info">
          ...
          <div v-else class="profile-avatar">
            ...
            <img v-else :src="user.avatar" :alt="user.name + ' ' + user.surname1 + ' - Foto de perfil de usuario'">
          </div>
      ...
      <div class="profile-content">
        <div class="profile-tabs">
          <div class="profile-tabs-group">
            <Button @click="fetchProducts(`getAllToSell`, user.id, 'activeProducts')" label="Productos" icon="pi pi-shop" :badge="activeProducts.length" rounded />
...
import { Dialog, Password, Tabs, TabList, Tab, TabPanels, TabPanel, Tag, FileUpload, FloatLabel, InputText } from 'primevue';
