        ...
        <div class="col-md-12">
            <div class="card border-0">
                <div class="card-header bg-transparent">
                    ...
                    <router-link v-if="can('post-create')" :to="{ name: 'seed_products.create' }" class="btn btn-primary btn-sm float-end">
                        Create Post
                    </router-link>
                </div>
                            ...
                            <tr v-for="post in posts.data" :key="post.id">
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <router-link v-if="can('post-edit')"
                                                 :to="{ name: 'seed_products.edit', params: { id: post.id } }" class="badge bg-primary">Edit
                                    </router-link>
