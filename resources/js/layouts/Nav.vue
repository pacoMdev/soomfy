        ...
        <div class="container p-0 m-0 d-flex justify-content-between">
            <div class="d-flex w-50 align-items-center">
                <router-link to="/" class="navbar-brand">
                    <img src="/images/logo.svg" class="logo-size" alt="logo">Soomfy</router-link>
            </div>
            <div class="d-flex w-50 justify-content-end align-items-center">
                <ul class="navbar-nav align-items-center gap-2">
                    <button class="primary-button">Como funciona</button>
                    <router-link to="/app/chat" class="nav-link d-flex align-items-center gap-2">
                        <img src="/images/chat.svg" class="icons-size" alt="">
                        <p class="textSize-chat">Chat</p>
                    </router-link>
                    <router-link to="/app/favoritos" class="nav-link d-flex align-items-center">
          ...
          ç                  <li><hr class="dropdown-divider"></li>
                    ...
                    <router-link to="/app/subir-producto" class="nav-link d-flex align-items-center">
