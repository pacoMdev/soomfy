              ...
              <div class="align-items-center">
                    <ul class="navbar-nav align-items-center gap-2">
                        ...
                        <router-link v-if="authStore().user?.name" :to="'/app/profile'" class="nav-item dropdown">
                            <img v-if="authStore().user?.media" :src="authStore().user.media[0].original_url" class="icons-size" style="height: 30px; width: 30px; border-radius: 100px; background-color: antiquewhite;">
                            <img v-else :src="authStore().user.media[0].original_url" class="icons-size" style="height: 30px; width: 30px; border-radius: 100px; background-color: antiquewhite;">
                        </router-link>
